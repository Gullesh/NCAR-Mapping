    ...
    if k == 20:
        ...
        for n, x in enumerate(labels):
            ...
            if x == 0:
                ...
                d[60].append(Btot[n])
                d[61].append(Binctot[n])
                d[62].append(Bazitot[n])
                d[63].append(DopFtot[n])
                d[64].append(SLFFtot[n])
                d[65].append(CItot[n])
            elif x == 11:
                d[66].append(Btot[n])
                d[67].append(Binctot[n])
                d[68].append(Bazitot[n])
                d[69].append(DopFtot[n])
                d[70].append(SLFFtot[n])
                d[71].append(CItot[n])
            elif x == 12:
                d[72].append(Btot[n])
                d[73].append(Binctot[n])
                d[74].append(Bazitot[n])
                d[75].append(DopFtot[n])
                d[76].append(SLFFtot[n])
                d[77].append(CItot[n])
            elif x == 13:
                d[78].append(Btot[n])
                d[79].append(Binctot[n])
                d[80].append(Bazitot[n])
                d[81].append(DopFtot[n])
                d[82].append(SLFFtot[n])
                d[83].append(CItot[n])
            elif x == 14:
                d[84].append(Btot[n])
                d[85].append(Binctot[n])
                d[86].append(Bazitot[n])
                d[87].append(DopFtot[n])
                d[88].append(SLFFtot[n])
                d[89].append(CItot[n])
            elif x == 15:
                d[90].append(Btot[n])
                d[91].append(Binctot[n])
                d[92].append(Bazitot[n])
                d[93].append(DopFtot[n])
                d[94].append(SLFFtot[n])
                d[95].append(CItot[n])
            elif x == 16:
                d[96].append(Btot[n])
                d[97].append(Binctot[n])
                d[98].append(Bazitot[n])
                d[99].append(DopFtot[n])
                d[100].append(SLFFtot[n])
                d[101].append(CItot[n])
            elif x == 17:
                d[102].append(Btot[n])
                d[103].append(Binctot[n])
                d[104].append(Bazitot[n])
                d[105].append(DopFtot[n])
                d[106].append(SLFFtot[n])
                d[107].append(CItot[n])
            elif x == 18:
                d[108].append(Btot[n])
                d[109].append(Binctot[n])
                d[110].append(Bazitot[n])
                d[111].append(DopFtot[n])
                d[112].append(SLFFtot[n])
                d[113].append(CItot[n])
            elif x == 19:
                d[114].append(Btot[n])
                d[115].append(Binctot[n])
                d[116].append(Bazitot[n])
                d[117].append(DopFtot[n])
                d[118].append(SLFFtot[n])
                d[119].append(CItot[n])
        ...
        rows = [ ['0', 'RED', mean(d[0]), stdev(d[0]), mean(d[1]), stdev(d[1]),  mean(d[2]), stdev(d[2]), mean(d[3]), stdev(d[3]), mean(d[4]), stdev(d[4]), mean(d[5]), stdev(d[5])],  
             ...
             ['8', 'NAVY', mean(d[48]), stdev(d[48]), mean(d[49]), stdev(d[49]), mean(d[50]), stdev(d[50]), mean(d[51]), stdev(d[51]),  mean(d[52]), stdev(d[52]), mean(d[53]), stdev(d[53])],
             ['9', 'MAROON', mean(d[54]), stdev(d[54]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])],
             ['10', 'MAROON', mean(d[60]), stdev(d[60]), mean(d[61]), stdev(d[61]), mean(d[62]), stdev(d[62]), mean(d[63]), stdev(d[63]),  mean(d[64]), stdev(d[64]), mean(d[65]), stdev(d[65])],
             ['11', 'MAROON', mean(d[66]), stdev(d[66]), mean(d[67]), stdev(d[67]), mean(d[68]), stdev(d[68]), mean(d[69]), stdev(d[69]),  mean(d[70]), stdev(d[70]), mean(d[71]), stdev(d[71])],
             ['12', 'MAROON', mean(d[72]), stdev(d[72]), mean(d[73]), stdev(d[73]), mean(d[74]), stdev(d[74]), mean(d[75]), stdev(d[75]),  mean(d[76]), stdev(d[76]), mean(d[77]), stdev(d[77])],
             ['13', 'MAROON', mean(d[78]), stdev(d[78]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])],
             ['14', 'MAROON', mean(d[54]), stdev(d[54]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])],
             ['15', 'MAROON', mean(d[54]), stdev(d[54]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])],
             ['16', 'MAROON', mean(d[54]), stdev(d[54]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])],
             ['17', 'MAROON', mean(d[54]), stdev(d[54]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])],
             ['18', 'MAROON', mean(d[54]), stdev(d[54]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])],
             ['19', 'MAROON', mean(d[54]), stdev(d[54]), mean(d[55]), stdev(d[55]), mean(d[56]), stdev(d[56]), mean(d[57]), stdev(d[57]),  mean(d[58]), stdev(d[58]), mean(d[59]), stdev(d[59])]]  
...
fda = np.transpose(da)
kmeans = KMeans(n_clusters=10).fit(fda)
labels = kmeans.labels_
centers = kmeans.cluster_centers_
print('inertia: ', kmeans.inertia_)
pltmaps(labels, dimList, 10)
stdmean(labels, 10)
